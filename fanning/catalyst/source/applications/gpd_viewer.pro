...
FUNCTION GPD_Viewer::CheckKnownFileList, filename
    ...
    CASE rootname OF
        ...
        'N3A.GPD': BEGIN
            ...
            self.map_scaleID -> SetProperty, Value=12500.0D
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=608
            self.gridRowsID -> SetProperty, Value=896
            self.grid_ref_colID -> SetProperty, Value=307.5
            self.grid_ref_rowID -> SetProperty, Value=467.5
            self.grid_ref_latID -> SetProperty, Value=87.71424866D
            self.grid_ref_lonID -> SetProperty, Value=145.17550659D
        ...
        'N3B.GPD': BEGIN
            ...
            self.semimajor_axisID -> SetProperty, Value=6378273.0D
            self.semiminor_axisID -> SetProperty, Value=6356889.5D
            self.map_scaleID -> SetProperty, Value=25000.0D
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=304
            self.gridRowsID -> SetProperty, Value=448
            self.grid_ref_colID -> SetProperty, Value=153.5
            self.grid_ref_rowID -> SetProperty, Value=233.5
            self.grid_ref_latID -> SetProperty, Value=87.78072357D
            self.grid_ref_lonID -> SetProperty, Value=143.97262573D
            self.projectionID -> SetProperty, Selection='Polar Stereographic (North Pole)'
            self.datumID -> SetProperty, Selection='Hughes'
            mapInfo = self -> MapLabel_to_MapProj('Polar Stereographic (North Pole)')
            self.mapCoord -> SetProperty, MAP_PROJECTION=mapInfo.mapProjection, LIMIT=mapInfo.limit
        ...
        'NA25.GPD': BEGIN
            ...
            self.map_scaleID -> SetProperty, Value=200540.2D/8.0
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=361
            self.gridRowsID -> SetProperty, Value=361
            self.grid_ref_colID -> SetProperty, Value=180.0
            self.grid_ref_rowID -> SetProperty, Value=180.0
            self.grid_ref_latID -> SetProperty, Value=89.84059143D
            self.grid_ref_lonID -> SetProperty, Value=45.0D
        ...
        'NL.GPD': BEGIN
            ...
            self.grid_ref_colID -> SetProperty, Value=360.0
            self.grid_ref_rowID -> SetProperty, Value=360.0
            self.grid_ref_latID -> SetProperty, Value=90.00D
            self.grid_ref_lonID -> SetProperty, Value=0.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (North Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
            mapInfo = self -> MapLabel_to_MapProj('Azimuthal Equal-Area (North Pole)')
            self.mapCoord -> SetProperty, MAP_PROJECTION=mapInfo.mapProjection, LIMIT=mapInfo.limit
        ...
        'NH.GPD': BEGIN
            ...
            self.semimajor_axisID -> SetProperty, Value=6371228.0D
            self.semiminor_axisID -> SetProperty, Value=6371228.0D
            self.map_scaleID -> SetProperty, Value=200540.2D/16.0
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=1441
            self.gridRowsID -> SetProperty, Value=1441
            self.grid_ref_colID -> SetProperty, Value=720.0
            self.grid_ref_rowID -> SetProperty, Value=720.0
            self.grid_ref_latID -> SetProperty, Value=90.00D
            self.grid_ref_lonID -> SetProperty, Value=0.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (North Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
        ...
        'NA5.GPD': BEGIN
            ...
            self.semimajor_axisID -> SetProperty, Value=6371228.0D
            self.semiminor_axisID -> SetProperty, Value=6371228.0D
            self.map_scaleID -> SetProperty, Value=200540.2D/40.0
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=1805
            self.gridRowsID -> SetProperty, Value=1805
            self.grid_ref_colID -> SetProperty, Value=902.0
            self.grid_ref_rowID -> SetProperty, Value=902.0
            self.grid_ref_latID -> SetProperty, Value=89.96810913D
            self.grid_ref_lonID -> SetProperty, Value=45.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (North Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
            mapInfo = self -> MapLabel_to_MapProj('Azimuthal Equal-Area (North Pole)')
        ...
        'NA1.GPD': BEGIN
            ...
            self.semimajor_axisID -> SetProperty, Value=6371228.0D
            self.semiminor_axisID -> SetProperty, Value=6371228.0D
            self.map_scaleID -> SetProperty, Value=200540.2D/160.0
            self.mapUnitsPerGridID -> SetProperty, Value=1
            self.gridColsID -> SetProperty, Value=7220
            self.gridRowsID -> SetProperty, Value=7220
            self.grid_ref_colID -> SetProperty, Value=3610.0
            self.grid_ref_rowID -> SetProperty, Value=3610.0
            self.grid_ref_latID -> SetProperty, Value=89.99202728D
            self.grid_ref_lonID -> SetProperty, Value=45.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (North Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
            mapInfo = self -> MapLabel_to_MapProj('Azimuthal Equal-Area (North Pole)')
        ...
        'S3A.GPD': BEGIN
            ...
            self.grid_ref_colID -> SetProperty, Value=315.5
            self.grid_ref_rowID -> SetProperty, Value=347.5
            self.grid_ref_latID -> SetProperty, Value=-88.21067810D
            self.grid_ref_lonID -> SetProperty, Value=1.84761000D
        ...
        'S3B.GPD': BEGIN
            ...
            self.grid_ref_colID -> SetProperty, Value=157.5
            self.grid_ref_rowID -> SetProperty, Value=173.5
            self.grid_ref_latID -> SetProperty, Value=-88.26545D
            self.grid_ref_lonID -> SetProperty, Value=3.81406999D
            self.projectionID -> SetProperty, Selection='Polar Stereographic (South Pole)'
            self.datumID -> SetProperty, Selection='Hughes'
            mapInfo = self -> MapLabel_to_MapProj('Polar Stereographic (South Pole)')
            self.mapCoord -> SetProperty, MAP_PROJECTION=mapInfo.mapProjection, LIMIT=mapInfo.limit
        ...
        'SA25.GPD': BEGIN
            ...
            self.grid_ref_rowID -> SetProperty, Value=180.0
            self.grid_ref_latID -> SetProperty, Value=-89.84059143D
            self.grid_ref_lonID -> SetProperty, Value=135.0D
        ...
        'SA5.GPD': BEGIN
            ...
            self.grid_ref_colID -> SetProperty, Value=802.0
            self.grid_ref_rowID -> SetProperty, Value=802.0
            self.grid_ref_latID -> SetProperty, Value=-89.96810913D
            self.grid_ref_lonID -> SetProperty, Value=135.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (South Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
        ...
        'SA1.GPD': BEGIN
            ...
            self.grid_ref_colID -> SetProperty, Value=3210
            self.grid_ref_rowID -> SetProperty, Value=3210
            self.grid_ref_latID -> SetProperty, Value=-89.99202728D
            self.grid_ref_lonID -> SetProperty, Value=135.0D
            self.projectionID -> SetProperty, Selection='Azimuthal Equal-Area (South Pole)'
            self.datumID -> SetProperty, Selection='EASE-Grid Sphere'
...
FUNCTION GPD_Viewer::ConstructFilename, fileType
    ...
    metersPerGridCell = metersPerMapUnit * mapUnitsPerGridCell
...
PRO GPD_Viewer::EventHandler, event
   ...
   CASE StrUpCase(event.name) OF
      ...
      'GRID_CENTER_COLUMN': self -> UpdateGridCenterColRow
      'GRID_CENTER_ROW': self -> UpdateGridCenterColRow
      'GRID_CENTER_SELECTOR': BEGIN
            ...
            IF buttonValue EQ 'Lat/Lon' THEN BEGIN
                ...
                self.grid_ref_rowID -> SetProperty, Sensitive = 0
                self.grid_ref_colID -> SetProperty, Sensitive = 0
            ENDIF ELSE BEGIN
                self.grid_ref_latID -> SetProperty, Sensitive = 0
                self.grid_ref_lonID -> SetProperty, Sensitive = 0
                self.grid_ref_rowID -> SetProperty, Sensitive = 1
                self.grid_ref_colID -> SetProperty, Sensitive = 1            
            ENDELSE
            END
      'NUMBER_MAP_UNITS_IN_GRID': self -> UpdateMapProjection
      ...
      'MAP_SCALE': self -> UpdateMapProjection
      'MAP_UNITS': self -> UpdateMapProjection
...
;     button = Obj_New('ButtonWidget', loadGPD, Value='Nl.gpd', NAME='NSIDC_GPD')
;     button = Obj_New('ButtonWidget', loadGPD, Value='Nh.gpd', NAME='NSIDC_GPD')
...
;     button = Obj_New('ButtonWidget', loadGPD, Value='Sl.gpd', NAME='NSIDC_GPD')
;     button = Obj_New('ButtonWidget', loadGPD, Value='Sh.gpd', NAME='NSIDC_GPD')
     ...
     self.map_ref_latID = Obj_New('FieldWidget', mapBase, VALUE = 90.0, DECIMAL=5, $
                             TITLE='Map Origin Latitude: ', LABELSIZE=labelsize, $
                             NAME='MAP_CENTER_LATITUDE', /CR_EVENTS, SENSITIVE=0)
     self.map_ref_lonID = Obj_New('FieldWidget', mapBase, VALUE = 0.0, DECIMAL=5, $
     ...
     self.map_scaleID = Obj_New('FieldWidget', mapBase, VALUE = 1.0, DECIMAL=4, $
                             TITLE='Number of Meters per Map Unit: ', LABELSIZE=labelsize, $
                             NAME='MAP_SCALE', /CR_EVENTS, /LABEL_LEFT)        
     self.mapUnitsPerGridID = Obj_New('FieldWidget', gridBase, VALUE = 5000.0, DECIMAL=5, $
                             TITLE='Number of Map Units per Grid Cell: ', LABELSIZE=labelsize, $
                             NAME='NUMBER_MAP_UNITS_IN_GRID', /CR_EVENTS, /LABEL_LEFT)        
     self.gridColsID = Obj_New('FieldWidget', gridBase, VALUE = 1000, DIGITS=5, $
                             TITLE='Number of Grid Columns: ', LABELSIZE=labelsize, $
                             NAME='GRID_XSIZE', /CR_EVENTS, /LABEL_LEFT)
     self.gridRowsID = Obj_New('FieldWidget', gridBase, VALUE = 1000, DIGITS=5, $
     ...
     latlonbutton = Obj_New('ButtonWidget', selectBase, Value='Lat/Lon', /NO_RELEASE, NAME='GRID_CENTER_SELECTOR')
     colrowbutton = Obj_New('ButtonWidget', selectBase, Value='Col/Row', /NO_RELEASE, NAME='GRID_CENTER_SELECTOR')
     latlonbutton -> SetProperty, SET_BUTTON=1
     self.grid_ref_latID = Obj_New('FieldWidget', gridBase, VALUE = 90.0, DECIMAL=5, $
                             TITLE='Grid Center Latitude: ', LABELSIZE=labelsize, $
                             NAME='GRID_CENTER_LATITUDE', /CR_EVENTS)
     self.grid_ref_lonID = Obj_New('FieldWidget', gridBase, VALUE = 0.0, DECIMAL=5, $
                             TITLE='Grid Center Longitude: ', LABELSIZE=labelsize, $
                             NAME='GRID_CENTER_LONGITUDE', /CR_EVENTS)
     self.grid_ref_colID = Obj_New('FieldWidget', gridBase, VALUE = 500.0, DECIMAL=5, $
                             TITLE='Grid Column at Map Origin: ', LABELSIZE=labelsize, $
                             NAME='GRID_CENTER_COLUMN', /CR_EVENTS, SENSITIVE=0)
     self.grid_ref_rowID = Obj_New('FieldWidget', gridBase, VALUE = 500.0, DECIMAL=5, $
                             TITLE='Grid Row at Map Origin: ', LABELSIZE=labelsize, $
                             NAME='GRID_CENTER_ROW', /CR_EVENTS, SENSITIVE=0)
...
PRO GPD_Viewer::Open_GPD_File, filename
    ...
    IF count GT 0 THEN BEGIN
        ...
        ReadS, thisLine, grid_center_lat, FORMAT ='(30x, D0.5)'
    ...
    IF count GT 0 THEN BEGIN
        ...
        ReadS, thisLine, grid_center_lon, FORMAT ='(30x, D0.5)'
    ...
    IF count GT 0 THEN BEGIN
        ...
        ReadS, thisLine, grid_column_at_map_origin, FORMAT ='(30x, F0.2)'
        self.grid_ref_colID -> SetProperty, Value=grid_column_at_map_origin
     ENDIF
    ...
    IF count GT 0 THEN BEGIN
        ...
        ReadS, thisLine, grid_row_at_map_origin, FORMAT ='(30x, F0.2)'
        self.grid_ref_rowID -> SetProperty, Value=grid_row_at_map_origin
     ENDIF
    ...
    ; Calculate column and row centers and draw. Only have to do this if
    ; you didn't find the information in the file.
    IF N_Elements(grid_column_at_map_origin) EQ 0 THEN self -> UpdateGridCenterLatLon
...
PRO GPD_Viewer::SelectGridCenter, event
    ...
    self.grid_ref_rowID -> SetProperty, Value=(grid_rows / 2.0) + ycells
    self.grid_ref_colID -> SetProperty, Value=(grid_cols / 2.0) - xcells
...
PRO GPD_Viewer::SetDefaultGPDGrid
    ...
    self.map_scaleID -> SetProperty, Value=1

    ; Set current grid settings on the display.
    self.gridRowsID -> SetProperty, Value=1000
    self.gridColsID -> SetProperty, Value=1000
    self.grid_ref_colID -> SetProperty, Value=500
    self.grid_ref_rowID -> SetProperty, Value=500
...
PRO GPD_Viewer::SetMapProjection, SKIP_LATLON_UPDATE=skip_latlon_update
   ...
   @cat_pro_error_handler
    ...
    self.gridRowsID -> GetProperty, Value=grid_rows
    self.gridColsID -> GetProperty, Value=grid_cols
    self.grid_ref_colID -> GetProperty, Value=grid_center_col
    self.grid_ref_rowID -> GetProperty, Value=grid_center_row
...
;+
; NAME:
;       GPD_VIEWER::UpdateGridCenterColRow
;
; PURPOSE:
;
;       This method is called whenever the user changes the grid center column or row
;       at map origin fields. It's purpose is to update the grid center latitude and
;       longitude fields on the GUI.
;
; SYNTAX:
;
;     theObject -> UpdateGridCenterColRow
;
; ARGUMENTS:
;
;     None.
...
;-
;*****************************************************************************************************
PRO GPD_Viewer::UpdateGridCenterColRow
    ...
    self.grid_ref_colID -> GetProperty, Value=col
    self.grid_ref_rowID -> GetProperty, Value=row
    
    ; How many meters is this from the map origin
    self.mapUnitsPerGridID -> GetProperty, Value=mapUnitsPerGridCell
    self.map_scaleID -> GetProperty, Value=metersPerMapUnit
    self.gridRowsID -> GetProperty, Value=grid_rows
    self.gridColsID -> GetProperty, Value=grid_cols
    xMeters = ((grid_cols/2.0d) - col) * mapUnitsPerGridCell * metersPerMapUnit
    yMeters = -((grid_rows/2.0d) - row) * mapUnitsPerGridCell * metersPerMapUnit
    
    ; Convert the number of meters to lat/lon.
    ll = Map_Proj_Inverse(xmeters, ymeters, MAP_STRUCTURE=self.mapCoord->GetMapStructure())            
...
PRO GPD_Viewer::UpdateGridCenterLatLon
    ...
    self.gridRowsID -> GetProperty, Value=grid_rows
    self.gridColsID -> GetProperty, Value=grid_cols
    self.grid_ref_rowID -> SetProperty, Value=(grid_rows / 2.0D) + ycells
    self.grid_ref_colID -> SetProperty, Value=(grid_cols / 2.0D) - xcells
...
;-
;*****************************************************************************************************
PRO GPD_Viewer::UpdateLatLonLocations, ll
    ...
    self.lon_ll -> SetProperty, Value=String(ll[0,0], Format='(F0.3)'), UVALUE=ll[0,0]
    self.lon_ul -> SetProperty, Value=String(ll[0,1], Format='(F0.3)'), UVALUE=ll[0,1]
    self.lon_ur -> SetProperty, Value=String(ll[0,2], Format='(F0.3)'), UVALUE=ll[0,2]
    self.lon_lr -> SetProperty, Value=String(ll[0,3], Format='(F0.3)'), UVALUE=ll[0,3]
    
    self.lat_ll -> SetProperty, Value=String(ll[1,0], Format='(F0.3)'), UVALUE=ll[1,0]
    self.lat_ul -> SetProperty, Value=String(ll[1,1], Format='(F0.3)'), UVALUE=ll[1,1]
    self.lat_ur -> SetProperty, Value=String(ll[1,2], Format='(F0.3)'), UVALUE=ll[1,2]
    self.lat_lr -> SetProperty, Value=String(ll[1,3], Format='(F0.3)'), UVALUE=ll[1,3]
...
PRO GPD_Viewer::UpdateGridLocation
    ...
    self.gridRowsID -> GetProperty, Value=grid_rows
    self.gridColsID -> GetProperty, Value=grid_cols
    map_origin_row = (grid_rows / 2.0D) + ycells
    map_origin_col = (grid_cols / 2.0D) - xcells
    self.grid_ref_rowID -> SetProperty, Value=map_origin_row
    self.grid_ref_colID -> SetProperty, Value=map_origin_col
    
    
    ; Find the XY limits of the given map projection. Remember, the *GRID*
    ; origin is in the upper left corner [at (0.5, 0.5) in the center of the
    ; first grid cell], positive columns to the right and positive rows down, 
    ; even though the XY map origin is the reverse of this, with its origin
    ; at the map center, positive X to right and positive Y up. The following
    ; code is identical to the code used at NSIDC.
    metersPerGridCell = metersPerMapUnit * mapUnitsPerGridCell
    ulx = metersPerGridCell * (-1 * (map_origin_col + 0.5))
    uly = metersPerGridCell * (map_origin_row + 0.5)
...
PRO GPD_Viewer::Write_GPD_File, event
    ...
    map_equatorial_radius = DblToStr(map_equatorial_radius)
    self.semiminor_axisID -> GetProperty, Value=map_polar_radius
    map_polar_radius = DblToStr(map_polar_radius)
    ...
    self.map_truescaleID -> GetProperty, Value=truescale
    self.grid_ref_rowID -> GetProperty, Value=grid_row_at_map_origin
    self.grid_ref_colID -> GetProperty, Value=grid_column_at_map_origin
    ...
    grid_center_lat = String(grid_center_lat, Format='(D0.8)')
    grid_center_lon = String(grid_center_lon, Format='(D0.8)')
    grid_row_at_map_origin = String(grid_row_at_map_origin, FORMAT='(F0.2)')
    grid_column_at_map_origin = String(grid_column_at_map_origin, FORMAT='(F0.2)')
        
    ; Get the map origins.
    self.lon_ul -> GetProperty, Value=lon_origin
    self.lat_ul -> GetProperty, Value=lat_origin
    mapStruct = self.mapCoord -> GetMapStructure()
    xy = Map_Proj_Forward(lon_origin, lat_origin, MAP_STRUCTURE=mapStruct)
    map_origin_x = StrTrim(String(xy[0], Format='(F12.2)'), 2)
    map_origin_y = StrTrim(String(xy[1], Format='(F12.2)'), 2)
     ...
     PrintF, lun, 'Grid Map Origin Column:', grid_column_at_map_origin, FORMAT='(A-30,x,A-45)'
     PrintF, lun, 'Grid Map Origin Row:', grid_row_at_map_origin, FORMAT='(A-30,x,A-45)'
...
;       represented on the GUI. The files will consist of floating-point array of 
...
; SYNTAX:
;
;     theObject -> Write_LatLon_Files, fileType
;
; ARGUMENTS:
;
;     None.
...
;-
;*****************************************************************************************************
PRO GPD_Viewer::Write_LatLon_Files
    ...
    IF theError NE 0 THEN BEGIN
     ...
     ; Get the map origins (lower-left) and opposite corner. Put them into UV coordinates.
     self.lon_ll -> GetProperty, UValue=lon_origin
     self.lat_ll -> GetProperty, UValue=lat_origin
     self.lon_ur -> GetProperty, UValue=lon_end
     self.lat_ur -> GetProperty, UValue=lat_end
     mapStruct = self.mapCoord -> GetMapStructure()
     xy = Map_Proj_Forward([lon_origin, lon_end], [lat_origin, lat_end], MAP_STRUCTURE=mapStruct)
     map_origin_x = xy[0,0]
     map_origin_y = xy[1,0]
     map_end_x = xy[0,1]
     map_end_y = xy[1,1]
;     Print, 'Longitude range (LL): ', lon_origin, lon_end
;     Print, 'Longitude range (UV): ', map_origin_x, map_end_x
;     Print, 'Latitude range (LL): ', lat_origin, lat_end
;     Print, 'Latitude range (UV): ', map_origin_y, map_end_y
 
     ; Collect data to calculate meters per grid cell.
     self.mapUnitsPerGridID -> GetProperty, Value=mapUnitsPerGridCell
     self.map_scaleID -> GetProperty, Value=metersPerMapUnit
     metersPerGridCell = Double(metersPerMapUnit) * mapUnitsPerGridCell
     ...
     latvector = (Dindgen(rows) * metersPerGridCell) + ( map_origin_y + (0.5 * metersPerGridCell) )
     lonvector = (Dindgen(cols) * metersPerGridCell) + ( map_origin_x + (0.5 * metersPerGridCell) )
...
;     ll = Map_Proj_Inverse(Rebin(lonvector, cols, rows), Rebin(Reform(latvector, 1, rows), cols, rows), MAP_STRUCTURE=mapStruct)
...
;     WriteU, lonlun, Float(Reform(ll[0,*], cols, rows))
     ...
     FOR j=0,rows-1 DO BEGIN
        ll = Map_Proj_Inverse(lonvector, Replicate(latvector[j], cols), MAP_STRUCTURE=mapStruct)
        WriteU, latlun, Float(Reform(ll[1,*]))
        WriteU, lonlun, Float(Reform(ll[0,*]))
     ENDFOR
     Free_Lun, latlun
     Free_Lun, lonlun
...
PRO GPD_Viewer::NotWorking, event
  void = Dialog_Message('This function not currently implemented.')
END
...
PRO GPD_Viewer__Define, class
   ...
   class = { GPD_Viewer, $
             ...
             map_scaleID: Obj_New(), $           ; Widget containing meters per map unit value.
             mapUnitsPerGridID: Obj_New(), $     ; Widget containing map units per grid cell value.
             ...
             grid_ref_rowID: Obj_New(), $        ; Widget for row pinned to grid center.
             grid_ref_colID: Obj_New(), $        ; Widget for column pinned to grid center.
