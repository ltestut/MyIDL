...
;   DWF, Mar 2010. Added Map_Grid_Check_Range function to check the latitude
;      and longitude label position to be sure it is inside the plot boundaries.
;      This fixes a problem with hardware and true-type fonts not being clipped
