FUNCTION read_lgp1_tugo, filename, tide=tide, uv=uv, transport=transport, var_name=var_name,  verbose=verbose,  info=info
; lecture de fichier netcdf de sortie de tugo sur grille non-structuree et mise dans une structure de type geomat
